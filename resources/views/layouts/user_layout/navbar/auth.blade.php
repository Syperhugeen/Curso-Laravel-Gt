...
{{--   <li id="icono-user-en-navbar" title="icono user"><a href=""><span class="glyphicon glyphicon-user"></span></a></li> --}}
@else
  <div class="user-menu hidden-xs"><h4 class="no-padding no-margin"><a  href="{{route('get_datos_home_web')}}"></span>{{Auth::user()->first_name}} <span class="glyphicon glyphicon-user"></a></h4>
  <h6><a href="{{route('get_datos_home_web')}}">Admin Panel</a> <strong>|</strong> <a href="{{route('logout')}}">Log-out</a></h6>
  </div>
@endif