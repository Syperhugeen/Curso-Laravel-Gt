<div class="container-fluid section-wrapper-footer bgcolor-2" id="footer">
  <div class="row">
   ...
   <div class="row">
    ...
    <!-- columna del isologo -->
    <div class="col-md-3 footer-line hidden-xs hidden-sm footer-col-height" style="text-align:right;">
    ...
    {{-- Logos nuevos --}}
     <div class="col-md-3 footer-line hidden-xs hidden-sm footer-col-height">
      ...
      <h5>Global Business Corporation</h5> 
    ...
    <div class="col-md-3 footer-line footer-responsive-vertical-space footer-col-height">
    ...
    <div class="col-md-3 footer-line3 footer-responsive-vertical-space footer-col-height">
 ...
 @endif
  ...
  <div class="row footer-responsive-vertical-space footer-last-row">
      ...
      <div class="col-md-6">
        <h5>Diseño de interfaz : <a href="http://www.simbiontecreativo.com/">Simbionte</a> y desarrollo web <a href="https://mauricio.mwebs.com.uy">MCS</a></h5>
      </div>
